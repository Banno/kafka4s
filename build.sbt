...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.apache.kafka" % "kafka-clients" % V.kafka exclude ("org.lz4", "lz4-java"), // GHSA-vqf4-7m7x-wgfc
    ...
    "io.confluent" % "kafka-avro-serializer" % V.confluent exclude ("org.lz4", "lz4-java"), // GHSA-vqf4-7m7x-wgfc,
